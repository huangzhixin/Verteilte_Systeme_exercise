...
public class VSAmoSemantics extends VSAbstractRPCSemantics{
	...
	public VSAmoSemantics(VSRemoteGroupReference Reference) {
		super(Reference);
	...
	private void sendAndStartTimer() throws Throwable
	{
		...
		if(tmpMessage.getMajorID() == message.getMajorID())
		{
