...
public class VSBuggyObjectConnection extends VSObjectConnection {
  ...
  private static final int         DROP_PROBABILITY      = 0;
  private static final int         DUPLICATE_PROBABILITY =  0;
  private static final int         DELAY_PROBABILITY     =  0;
  ...
  public Serializable receiveObject() throws ClassNotFoundException {
    ...
    while (this.incomingObjects.isEmpty()) {
      ...
      //System.err.println("receiveObject is :"+object);
      if (object == null)
        return null;
      ...
      if (random.nextInt(100) < DROP_PROBABILITY) {
        if (ENABLE_DEBUG_OUTPUT)
          ...
          message=(VSTestMessage) object;
          System.err.println("DROP: " + message.getMajorID()+" "+message.getMinorID());
        continue;
      }
